...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Profenglish/ProEng/index.css">
    <!-- <link type="Image/x-icon" href="http://localhost/Profenglish/ProEng/img/logo.svg" rel="icon"> -->
  </head>w
<body class="">

  <nav class="py-2  border-bottom bg-pink">
    <div class="container d-flex flex-wrap bg-pink"  bis_skin_checked="1" >
      <a href="index.php" class="nav-link link-body-emphasis px-2 active" aria-current="page"><img src="http://localhost/Profenglish/ProEng/img/logo.svg" alt="err" srcset="" sizes="" width="65%"></a>
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="faqs.php" class="nav-link link-body-emphasis px-2 text-white fw-bold">Часто задаваемые вопросы</a></li>
      </ul>
      <ul class="nav">
        <li class="nav-item">
